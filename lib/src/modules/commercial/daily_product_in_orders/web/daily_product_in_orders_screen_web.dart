...
import 'package:kardex_app_front/src/modules/commercial/daily_product_in_orders/cubit/read_daily_product_in_orders_cubit.dart';
...
class DailyProductInOrdersScreenWeb extends StatelessWidget {
  const DailyProductInOrdersScreenWeb({super.key});
...
class _BottomAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BottomAppBar(
      ...
      child: Builder(
        builder: (context) {
          if (state is! ReadDailyProductInOrdersSuccess) return const SizedBox.shrink();
