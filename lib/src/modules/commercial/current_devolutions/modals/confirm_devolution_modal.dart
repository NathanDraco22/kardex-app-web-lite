...
Future<bool?> showConfirmDevolutionModal(
          ...
          child: SafeArea(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(devolution.clientInfo.name, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                  Text("Total a Confirmar: $totalFormatted", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Text(
                            "Se va a CONFIRMAR la devolución, esta acción afectará el inventario y el estado de cuenta del cliente. La acción no se puede deshacer.",
