...
import 'package:kardex_app_front/src/modules/commercial/pending_invoice/web/pending_invoice_web_screen.dart';
...
class PendingClientScreenWeb extends StatelessWidget {
  const PendingClientScreenWeb({super.key});
