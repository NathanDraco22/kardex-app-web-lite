                  ...
                  children: [
                    DatePickerButton(
                      ...
                      onSelected: (value) {
                        ...
                        readCubit.loadDevolutionsHistory();
                      },
                    ),
                    TextButton.icon(
                      onPressed: () {
                        final devolutionRepo = context.read<DevolutionsRepository>();
                        showSimpleSearchDialog<DevolutionInDb>(
                          context,
                          title: "Buscar #Devolución",
                          searchFuture: (value) {
                            return devolutionRepo.getDevolutionByDocNumber(value);
                          },
                          onResult: (value) {
                            showDevolutionViewerDialog(context, value);
                          },
                        );
                      },
                      label: const Text("Buscar #Devolución"),
