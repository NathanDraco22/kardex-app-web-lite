                  ...
                  children: [
                    DatePickerButton(
                      ...
                      onSelected: (value) {
                        ...
                        readCubit.loadReceiptsHistory();
                      },
                    ),
                    TextButton.icon(
                      onPressed: () {
                        final receiptRepo = context.read<ReceiptsRepository>();
                        showSimpleSearchDialog<ReceiptInDb>(
                          context,
                          title: "Buscar #Recibo",
                          searchFuture: (value) {
                            return receiptRepo.getReceiptByDocNumber(value);
                          },
                          onResult: (value) {
                            showReceiptViewerDialog(context, value);
                          },
                        );
                      },
                      label: const Text("Buscar #Recibo"),
