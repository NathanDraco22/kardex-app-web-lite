...
import 'package:kardex_app_front/src/modules/finance/detail_invoice_history/web/invoice_history_web_screen.dart';

class DetailInvoiceHistoryScreen extends StatelessWidget {
  const DetailInvoiceHistoryScreen({super.key});
