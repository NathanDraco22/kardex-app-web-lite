...
Future<bool?> showReceiveTransferModal(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          "Se va a RECIBIR la transferencia, asegurando que todos los productos han llegado correctamente.",
                ...
                const Spacer(),
                CustomSlider(
                  hintText: "Desliza para Recibir",
                  hintIcon: Icons.check,
