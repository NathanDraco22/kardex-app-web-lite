...
import 'package:kardex_app_front/src/modules/inventory/product_movements/view/web/product_movements_screen_web.dart';
import 'package:kardex_app_front/src/tools/extensiones.dart';

import 'mobile/product_movements_screen_mobile.dart';
...
class _Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isMobile) return const ProductMovementsScreenMobile();

    return const ProductMovementsScreenWeb();
  }
}
