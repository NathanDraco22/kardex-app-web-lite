part of '../product_movements_screen_web.dart';
...
class MovementWebRow extends StatelessWidget {
  const MovementWebRow({
    super.key,
  ...
  @override
  Widget build(BuildContext context) {
    final unitCost = NumberFormatter.convertToMoneyLike(currentTransaction.averageCost);
